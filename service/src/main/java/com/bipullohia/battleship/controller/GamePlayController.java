...
public class GamePlayController {
	...
	public GamePlay startGame(@RequestBody GamePlay newgame) {
		...
		game.setShipCollectionPlayer1(newgame.getShipCollectionPlayer1());
		
		//generate a gameId and return to the client (the client will use that to start the gameplay)
		game.setGameId("abr-ahs-cut"); //TODO: figure out a way to generate this
		...
		if(validPlayer1) {
			...
			game.setShipCollectionPlayer2(gameService.getNewPlacedShipCollection());
